        ...
        if (skill && skill.url) {
          return (
            <motion.a
              ...
              whileTap={{ scale: 0.9 }}
            >
              <Image src={skill.url} alt={lib.name} width={30} height={30} />
            </motion.a>
          );
        }
        return null;
    ...
    <>
      <div className="mt-8 pb-8 flex flex-col md:flex-row justify-between items-center gap-y-6 gap-x-4 relative">
        <div className="flex-row">
          <div className="font-bold text-3xl">Feel free to reach out:</div>
          <motion.div
          ...
          >
            ...
            <div className="pl-1">oleg.i.tolochko@gmail.com</div>
          </motion.div>
          <SocialButtons />
        </div>
